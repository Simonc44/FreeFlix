    ...
    <>
      ...
      {!searchQuery && (
        <section className="relative h-[60vh] min-h-[400px] w-full flex items-end text-white">
          ...
          <div className="container relative pb-12">
            <h1 className="text-4xl md:text-6xl font-headline font-bold mb-4 max-w-2xl drop-shadow-lg">
              {featuredMovie.title}
            </h1>
            <p className="max-w-xl text-lg text-foreground/80 mb-6 drop-shadow">
      ...
      <div className="container py-12 space-y-12">
        {searchQuery ? (
          ...
          <>
            <div className="flex justify-center items-center gap-3 text-lg text-muted-foreground bg-card/50 p-4 rounded-lg border border-dashed">
              <Film className="h-6 w-6 text-primary" />
              <p>
                Le catalogue FreeFlix contient actuellement <strong>{movies.length} films</strong>.
              </p>
            </div>
